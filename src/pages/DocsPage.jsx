          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            <div style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                {[
                  'Open an issue on GitHub (https://github.com/tochukwuada/Gavel-app/issues) with your wallet address, the auction ID, and a description of the issue.',
                  'Gavel will acknowledge your request and review within 5 business days.',
              ...
              <div>
                ...
                <a
                  ...
                  style={{
                    ...
                    color: C.purpleLight, letterSpacing: '0.06em', textDecoration: 'none',
                  }}
                >
